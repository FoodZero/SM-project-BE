...
public interface PostRepository extends JpaRepository<Post, Long> {
    ...
    List<Post> findPostList(@Param("lastIndex") Long lastIndex, @Param("postTopicType") PostTopicType postTopicType, @Param("location") Location location, Pageable pageable);
}
